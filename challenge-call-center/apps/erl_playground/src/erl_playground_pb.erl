...
encode_msg_req(#req{type = F1, create_session_data = F2,
		    server_message_data = F3, operator_msg = F4},
	       Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
    ...
    if F4 == undefined -> B3;
	   ...
	   begin
	     ...
	     e_mfield_req_operator_msg(TrF4, <<B3/binary, 34>>,
				       TrUserData)
	   end
    end.
...
e_mfield_req_operator_msg(Msg, Bin, TrUserData) ->
...
'e_enum_req.type_enum'(server_message, Bin,
		       _TrUserData) ->
    <<Bin/binary, 2>>;
'e_enum_req.type_enum'(caller_id_request, Bin,
		       _TrUserData) ->
    <<Bin/binary, 3>>;
...
dfp_read_field_def_req(<<34, Rest/binary>>, Z1, Z2,
		       F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_req_operator_msg(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     F@_4, TrUserData);
dfp_read_field_def_req(<<>>, 0, 0, F@_1, F@_2, F@_3,
		       F@_4, _) ->
    #req{type = F@_1, create_session_data = F@_2,
	 server_message_data = F@_3, operator_msg = F@_4};
...
dg_read_field_def_req(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    case Key of
	  ...
	  d_field_req_server_message_data(Rest, 0, 0, F@_1, F@_2,
					  F@_3, F@_4, TrUserData);
      34 ->
	  d_field_req_operator_msg(Rest, 0, 0, F@_1, F@_2, F@_3,
				   F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
...
d_field_req_operator_msg(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_req_operator_msg(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_req_operator_msg(<<0:1, X:7, Rest/binary>>, N,
...
merge_msg_req(#req{create_session_data =
    ...
    #req{type = NFtype,
	 ...
	 operator_msg =
	     if PFoperator_msg /= undefined,
		NFoperator_msg /= undefined ->
		    merge_msg_operator_message(PFoperator_msg,
					       NFoperator_msg, TrUserData);
		PFoperator_msg == undefined -> NFoperator_msg;
		NFoperator_msg == undefined -> PFoperator_msg
	     end}.
...
v_msg_req(#req{type = F1, create_session_data = F2,
    ...
    if F4 == undefined -> ok;
       true ->
	   v_msg_operator_message(F4, [operator_msg | Path],
				  TrUserData)
    end,
    ok;
...
'v_enum_req.type_enum'(server_message, _Path,
		       _TrUserData) ->
    ok;
'v_enum_req.type_enum'(caller_id_request, _Path,
		       _TrUserData) ->
    ok;
     ...
     {{msg, req},
      [#field{name = type, fnum = 1, rnum = 2,
       ...
       #field{name = server_message_data, fnum = 3, rnum = 4,
	      ...
	      opts = []},
       #field{name = operator_msg, fnum = 4, rnum = 5,
...
'enum_symbol_by_value_req.type_enum'(2) ->
    server_message;
'enum_symbol_by_value_req.type_enum'(3) ->
    caller_id_request;
...
'enum_value_by_symbol_req.type_enum'(server_message) ->
    2;
'enum_value_by_symbol_req.type_enum'(caller_id_request) ->
    3;
